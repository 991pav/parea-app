      ...
      <Card className="bg-gradient-to-r from-white/95 to-white/90 backdrop-blur-xl border-0 shadow-2xl overflow-hidden transform hover:scale-[1.02] transition-all duration-300">
        <CardContent className="p-6">
          <div className="flex flex-col items-center justify-center mb-6">
            ...
            <h1 className="text-2xl font-bold text-black mb-2">Memories</h1>
            <p className="text-sm text-slate-500">Partagez vos plus beaux moments</p>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4 text-center">
            <div className="bg-gradient-to-br from-blue-50 to-violet-50 rounded-xl p-3 border border-blue-100 shadow-md transform hover:scale-105 transition-transform duration-200">
              ...
              <p className="text-xs text-slate-500">Souvenirs</p>
            </div>
            <div className="bg-gradient-to-br from-blue-50 to-violet-50 rounded-xl p-3 border border-blue-100 shadow-md transform hover:scale-105 transition-transform duration-200">
              <p className="text-2xl font-bold text-blue-600">{memories.reduce((sum, m) => sum + m.likes, 0)}</p>
              <p className="text-xs text-slate-500">J'aime</p>
            </div>
        ...
        <CardContent className="p-4 space-y-4">
          <div className="relative">
            ...
            <Input
              ...
              className="pl-10 bg-white border-gray-300 text-slate-700 placeholder:text-slate-400 focus:border-pink-400 focus:ring-pink-400 shadow-sm"
            />
          </div>
                ...
                <Button
                  ...
                  className={`${
                    filterType === filter.id
                      ...
                      : "bg-white text-slate-600 border-gray-300 hover:bg-pink-50 hover:border-pink-300"
        ...
        {filteredMemories.length === 0 ? (
          <Card className="bg-white/95 backdrop-blur-xl border-0 shadow-2xl">
            <CardContent className="p-8 text-center">
              ...
              <h3 className="text-lg font-medium text-black mb-2">Aucun souvenir trouvé</h3>
              <p className="text-slate-500 mb-4">Commencez à créer de beaux souvenirs avec {activeChild}</p>
              <Button
              ...
              <div className="p-4 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="font-medium text-black">{memory.author}</p>
                  ...
                  <div className="flex items-center space-x-2 relative">
                    <div className="flex items-center text-slate-400">{getTypeIcon(memory.type)}</div>
                    ...
                    {openMenu[memory.id] && (
                      ...
                      >
                        <div className="p-3">
                          <div className="text-sm font-semibold text-black px-2 py-2 mb-2 border-b border-gray-100">Actions</div>
                          
                          <div className="space-y-1 mb-3">
                            <div className="text-xs font-medium text-slate-500 px-2 py-1">Visibilité</div>
                            
                            <button 
                              className="w-full text-left px-3 py-2.5 hover:bg-blue-50 rounded-md text-sm text-black flex items-center space-x-3 transition-colors duration-150" 
                          ...
                          <div className="space-y-1 mb-3">
                            <div className="text-xs font-medium text-slate-500 px-2 py-1">Actions</div>
                            
                            <button 
                              className="w-full text-left px-3 py-2.5 hover:bg-orange-50 rounded-md text-sm text-black flex items-center space-x-3 transition-colors duration-150" 
                          ...
                          <div className="space-y-1">
                            <div className="text-xs font-medium text-slate-500 px-2 py-1">Danger</div>
                            
                            <button 
                              className="w-full text-left px-3 py-2.5 hover:bg-red-50 rounded-md text-sm text-black flex items-center space-x-3 transition-colors duration-150" 
              ...
              <div className="p-4">
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center space-x-4">
                    ...
                    <Button variant="ghost" size="sm" className="p-2 text-slate-600 hover:text-slate-800 transform hover:scale-110 transition-all duration-200">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-black leading-relaxed">{memory.description}</p>
                ...
                {openComments[memory.id] && (
                  <div className="mt-4 space-y-3 border-t border-gray-100 pt-3">
                    <div className="text-sm font-medium text-black mb-2">💬 Commentaires</div>
        ...
        <Card className="bg-white/95 backdrop-blur-xl border-0 shadow-2xl">
          ...
          <CardContent className="space-y-4">
            <Textarea
              ...
              className="bg-white border-gray-300 text-black placeholder:text-slate-400 focus:border-pink-400 focus:ring-pink-400 min-h-[100px] shadow-sm"
            />
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-black">Visibilité</label>
              <select className="w-full p-2 bg-white border border-gray-300 rounded-md text-black focus:border-pink-400 focus:ring-pink-400 shadow-sm">
